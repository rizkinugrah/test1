  ...
  <div class="col-sm-12">
    <div class="card-pf">
      ...
      <div class="card-pf-footer" style="">
        <a href="<?php echo base_url('reportapproval/markAsApproved/'.$reports->id.'/'.$documentApproverId); ?>" class="btn btn-success" type="button">
          <i class="fa fa-check"></i> Mark as Approved
        </a>
        &nbsp;
        <a href="<?php echo base_url('reportapproval/markAsRevised/'.$reports->id.'/'.$documentApproverId); ?>" class="btn btn-warning" type="button">
